...
// var hoisiting(move declaration from bottom to top)
// has no block scope
{
  age = 4;
  var age;
...
// favor immutable data type always for a faw reasons:
// 	- securify
// 	- thread safety
...
// number - speica numeric values: infinity, -infinity, NaN
const infinity = 1 / 0;
